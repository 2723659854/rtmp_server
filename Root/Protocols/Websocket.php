...
class Websocket implements ProtocolInterface
{
    ...
    public static function input($buffer, ConnectionInterface $connection)
    {
        ...
        if ($connection->context->websocketCurrentFrameLength) {
            ...
            if (!$masked) {
                echo "frame not masked so close the connection\n";
                $connection->close();
                return 0;
            }
    ...
    public static function dealHandshake($buffer, $connection)
    {
        ...
        if (0 === \strpos($buffer, 'GET')) {
            ...
            if (\preg_match("/Sec-WebSocket-Key: *(.*?)\r\n/i", $buffer, $match)) {
                ...
                $connection->close("HTTP/1.1 200 WebSocket\r\nServer: xiaosongshu /" . "v1.0" . "\r\n\r\n
<div style=\"text-align:center\"><h1>WebSocket</h1><hr>xiaosongshu/" . "v1.0" . "</div>",
                    true);
                return 0;
            }
            /** 计算秘钥 */
            ...
            if (!$has_server_header) {
                $handshake_message .= "Server: xiaosongshu/v1.0.0\r\n";
            }
            $handshake_message .= "\r\n";
        ...
        $connection->close("HTTP/1.1 200 WebSocket\r\nServer: xiaosongshu/v1.0.0 \r\n\r\n<div style=\"text-align:center\"><h1>WebSocket</h1><hr>xiaosongshu/ v1.0.0</div>",
            true);
        return 0;
    }
